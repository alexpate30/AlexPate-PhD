...
load("R_out_C6/runsim_male_RR065_no1pres.RData")
...
## Risk straight away
disc.age.50.adj[10,1]

## Risk wait 10 years
disc.age.50.adj[10,11]
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                                     common.legend = FALSE)
ggsave("figures/res_male_RR065_no1pres.jpg",comb.plot, height = 9, width = 4.5)

save.image("R_out_C6/res_male_RR065_no1pres.RData")
print("image saved")
