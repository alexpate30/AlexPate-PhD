...
load("R_out_C6/runsim_female_RR07.RData")
...
## Get risks for illustrative example

## Risk straight away
disc.age.50.adj[9,1]

## Risk wait 10 years
disc.age.50.adj[9,11]
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                                     common.legend = FALSE)
ggsave("figures/res_female_RR07.jpg",comb.plot, height = 9, width = 4.5)

save.image("R_out_C6/res_female_RR07.RData")
print("image saved")