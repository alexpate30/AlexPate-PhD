...
load("R_out_C6/generate_model_agetime_male_FAKE.RData")
...
S<-model.matrix(Surv(CVD_time,CVD_cens_R, type='right') ~ BMI +  Atrialfib+ Atypical_antipsy_med+ 
...
save.image("R_out_C6/generate_risk_range_for_each_age_agetime_male_FAKE.RData")
