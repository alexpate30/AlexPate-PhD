...
load("R_out_C6/statin_discontinuation_rates_for_sim_continuous_multiple_treatment_periods_rates_agemod.RData")
...
save.image("R_out_C6/runsim_female_RR065_discadj.RData")
print("image saved")
