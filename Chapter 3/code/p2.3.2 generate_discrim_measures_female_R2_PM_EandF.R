### In this program I will calculate R2_PM for models E and F (female cohort)
...
R2_PM.F<-c(R2_PM.1,R2_PM.2)

rm(list=setdiff(ls(),list("R2_PM.E","R2_PM.F")))
setwd("B")
save.image("generate_discrim_measures_female_R2_PM_EandF.RData")