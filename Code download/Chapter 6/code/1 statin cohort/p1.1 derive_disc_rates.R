...
setwd("/mnt/ja01-home01/mbrxsap3/statin_persistance/R/")
# 
...
# ggsave("Disc1_restrict.jpg",print(a))
# 
...
# ggsave("Restart1_restrict.jpg",print(b))
# 
...
# ggsave("Disc2_restrict.jpg",print(c))
# 
...
# ggsave("Restart2_restrict.jpg",print(d))
# 
...
# ggsave("Disc3_restrict.jpg",print(e))
# 
...
# ggsave("Restart3_restrict.jpg",print(f))
# 
...
# ggsave("Disc4_restrict.jpg",print(g))

rm(list=setdiff(ls(),list("disc_sum","disc2_sum","disc3_sum","restart_sum","restart2_sum","disc4_sum","restart3_sum",
...
save.image("R_out_C6/survival_curves_restricted_1_year_FAKE.RData")
