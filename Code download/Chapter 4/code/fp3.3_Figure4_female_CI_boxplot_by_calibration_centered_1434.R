...
ggsave("figures/Figure4_female_CI_boxplot_by_calibration_centered_1434.jpeg",Figure4_female_CI_boxplot_by_calibration_centered_1434, dpi = 300, height = 3.5, width = 10.5)
