##### This program will develop the random intercept model used for models E and F (male cohort)
##### This program will develop the random intercept model used for models E and F (male cohort)
##### This program will develop the random intercept model used for models E and F (male cohort)
...
fit_data_parallel.1<-(foreach(input=list(long_data_parallel_devel[[1]],long_data_parallel_devel[[2]],long_data_parallel_devel[[3]],long_data_parallel_devel[[4]],long_data_parallel_devel[[5]],
                      ...
                      %dopar%{coxme(Surv(CVD_time,CVD_cens_R, type='right') ~ agefrac1 + agefrac2 + BMI + Alcohol_abuse+ Anxiety+ Atrialfib+ Atypical_antipsy_med+ 
...
setwd("B")
save.image("models_male_modelE.RData")
