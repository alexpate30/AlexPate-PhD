...
load("R_out_C6/statin_discontinuation_rates_for_sim_continuous_multiple_treatment_periods_no1pres_agemod_FAKE.RData")
...
save.image("R_out_C6/statin_discontinuation_rates_for_sim_continuous_multiple_treatment_periods_rates_no1pres_agemod_FAKE.RData")
