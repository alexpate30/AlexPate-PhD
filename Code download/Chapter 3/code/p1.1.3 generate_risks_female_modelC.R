##### This program will generate the risks for each patient according to model C (female cohort)
##### This program will generate the risks for each patient according to model C (female cohort)
##### This program will generate the risks for each patient according to model C (female cohort)
