...
res.C.med <- res.C.med.obj$"plot.box" + ggtitle(paste("Medium C statistics\nNumber of models =",dim(C.groups[[2]])[2],sep=" "))
print("start high")
Sys.time()
res.C.high.obj <- create.box.plot(C.groups[[3]])
res.C.high <- res.C.high.obj$"plot.box" + ggtitle(paste("High C statistics\nNumber of models =",dim(C.groups[[3]])[2],sep=" "))
Sys.time()
...
ggsave("figures/Figure3_female_CI_boxplot_by_C_statistic_1434.jpeg",Figure3_female_CI_boxplot_by_C_statistic_1434, dpi = 600, height = 3.5, width = 10.5)
