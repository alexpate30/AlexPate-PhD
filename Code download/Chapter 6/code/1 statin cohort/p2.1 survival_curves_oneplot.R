...
load("R_out_C6/survival_curves_restricted_1_year.RData")
...
ggsave("figures/Discontinuation survival plots one graph first three 1year restricted_FAKE.jpg",print(disc.gg.plot.3))
ggsave("figures/Discontinuation survival plots one graph first four 1year restricted_FAKE.jpg",print(disc.gg.plot.4))
ggsave("figures/Restarting survival plots one graph 1year restricted_FAKE.jpg",print(res.gg.plot))

Figure2 <- arrange_ggsurvplots(list(disc.gg.plot.4, res.gg.plot), ncol=2, nrow = 1)
Figure2
ggsave("figures/Figure2.jpg",Figure2, width = 10, height = 7, unit = "in", dpi = 600)
