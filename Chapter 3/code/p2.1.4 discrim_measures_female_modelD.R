...
##### ,Roystons and Saubrei's R^2_D and Gonen and Hellers C for model D (female cohort)
...
### Now I want to compare to my other method for calculating R squared
...
setwd("B")
save.image("discrim_mesaures_female_modelD.RData")
