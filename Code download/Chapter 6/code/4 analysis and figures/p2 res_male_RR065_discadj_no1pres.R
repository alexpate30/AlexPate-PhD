...
load("R_out_C6/runsim_male_RR065_discadj_no1pres.RData")
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                       common.legend = FALSE)
ggsave("figures/res_male_RR065_discadj_no1pres.jpg",comb.plot, height = 9, width = 4.5)

rm(anal.dat, comp.data)

save.image("R_out_C6/res_male_RR065_discadj_no1pres.RData")
