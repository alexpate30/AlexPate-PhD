### In this program I will calculate rho_wa for models E and F (female cohort)
...
rho_wa.F<-c(rho_wa.1,rho_wa.2)

rm(list=setdiff(ls(),list("rho_wa.E","rho_wa.F")))
setwd("B")
save.image("generate_discrim_measures_female_rho_wa_EandF.RData")