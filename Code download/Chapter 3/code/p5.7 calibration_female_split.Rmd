---
title: "calibration_female_split.R"
author: "Alex Pate"
date: "12/03/2018"
...
Average predicted risk in female cohort
```{r,echo=FALSE}
pred.risk
```

Average observed risk in female cohort
```{r,echo=FALSE}
obs.risk
```
...
# Now plot
p<-ggplot(temp.dat) 
p+ geom_point(aes(x=percentile,y=value,shape=variable)) + scale_shape_manual(values=c(1,19)) + ggtitle("Female - All patients") + ylab("Average 10 year risk")
```