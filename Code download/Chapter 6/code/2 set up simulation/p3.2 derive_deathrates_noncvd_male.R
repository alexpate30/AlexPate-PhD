...
table(deathdates_CPRD_ONS$gender)
...
deathdates_CPRD_ONS <- deathdates_CPRD_ONS[deathdates_CPRD_ONS$gender == 1,]
...
write.csv(inc.rates.table.riskcohort,"data/noncvd death rates riskcohort CPRD male_FAKE.csv")
