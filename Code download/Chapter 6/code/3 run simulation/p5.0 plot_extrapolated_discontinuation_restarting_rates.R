...
ggsave("figures/discontinuation1.extrapolation.jpeg", plot.disc1)
...
ggsave("figures/discontinuation23.extrapolation.jpeg", plot.disc23)
...
ggsave("figures/restarting.extrapolation.jpeg", plot.data.restart)