...
## The functions here will be used to run the simulation

## I am loading the age time models for the male cohort here just to test the functions work
...
run.simulation.agetime.male <- function(risk.in, age.in, discontinuation.in, treatment.start.in, treatment.effect.in){
  ...
  death.rates <- read.csv("data/noncvd death rates riskcohort CPRD male.csv",header=TRUE)
...
## Note I am removing basehaz and stuff because I am just saving these functions for either male or male cohort
rm(list=setdiff(ls(),list("run.simulation.agetime.CPRDdisc.cont.multiple.treat","run.simulation.agetime.male","get.cond.lifetime.risks","get.HR",
                          "get.10y.risk.nodeath","get.marg.risk.nodeath")))


save.image("R_out_C6/simulation_functions_agetime_models_male_FAKE.RData")
