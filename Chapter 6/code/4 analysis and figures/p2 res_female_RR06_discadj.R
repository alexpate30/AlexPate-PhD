...
load("R_out_C6/runsim_female_RR06_discadj.RData")
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                       common.legend = FALSE)
ggsave("figures/res_female_RR06_discadj.jpg",comb.plot, height = 9, width = 4.5)

rm(anal.dat, comp.data)

save.image("R_out_C6/res_female_RR06_discadj.RData")
