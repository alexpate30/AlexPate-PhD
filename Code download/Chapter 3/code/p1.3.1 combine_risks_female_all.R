...
setwd("B")
load("risks_female_modelA.RData")
...
load("risks_female_modelB.RData")
...
load("risks_female_modelC.RData")
...
load("risks_female_modelD.RData")
...
load("risks_female_modelE.RData")
...
load("risks_female_modelF.RData")
...
save.image("risks_female_all.RData")
print('image saved')
