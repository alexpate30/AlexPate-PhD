### SET ROOT DIRECTORY
setwd("mnt/bmh01-rds/vanstaa/practice2019/alex/Chapter6/")
### SET ROOT DIRECTORY
...
load("R_out_C6/runsim_male_RR07.RData")
...
disc.age.40.adj[5,] <- 100*(temp.5 - disc.age.40[5,])
disc.age.40.adj[6,] <- 100*(temp.6 - disc.age.40[6,])
...
## Then deduct it from the risk assuming no statin treatment
## I only go up to 20% if risks are beyond this
disc.age.50.adj[1,] <- 100*(temp.3 - disc.age.50[1,])
disc.age.50.adj[2,] <- 100*(temp.4 - disc.age.50[2,])
disc.age.50.adj[3,] <- 100*(temp.5 - disc.age.50[3,])
disc.age.50.adj[4,] <- 100*(temp.6 - disc.age.50[4,])
disc.age.50.adj[5,] <- 100*(temp.7 - disc.age.50[5,])
disc.age.50.adj[6,] <- 100*(temp.8 - disc.age.50[6,])
disc.age.50.adj[7,] <- 100*(temp.9 - disc.age.50[7,])
disc.age.50.adj[8,] <- 100*(temp.10 - disc.age.50[8,])
disc.age.50.adj[9,] <- 100*(temp.11 - disc.age.50[9,])
disc.age.50.adj[10,] <- 100*(temp.12 - disc.age.50[10,])
disc.age.50.adj[11,] <- 100*(temp.13 - disc.age.50[11,])
disc.age.50.adj[12,] <- 100*(temp.14 - disc.age.50[12,])
disc.age.50.adj[13,] <- 100*(temp.15 - disc.age.50[13,])
disc.age.50.adj[14,] <- 100*(temp.16 - disc.age.50[14,])
disc.age.50.adj[15,] <- 100*(temp.17 - disc.age.50[15,])
disc.age.50.adj[16,] <- 100*(temp.18 - disc.age.50[16,])
disc.age.50.adj[17,] <- 100*(temp.19 - disc.age.50[17,])
disc.age.50.adj[18,] <- 100*(temp.20 - disc.age.50[18,])
...
## Then deduct it from the risk assuming no statin treatment
## I only go up to 20% if risks are beyond this
disc.age.60.adj[1,] <- 100*(temp.7 - disc.age.60[1,])
disc.age.60.adj[2,] <- 100*(temp.8 - disc.age.60[2,])
disc.age.60.adj[3,] <- 100*(temp.9 - disc.age.60[3,])
disc.age.60.adj[4,] <- 100*(temp.10 - disc.age.60[4,])
disc.age.60.adj[5,] <- 100*(temp.11 - disc.age.60[5,])
disc.age.60.adj[6,] <- 100*(temp.12 - disc.age.60[6,])
disc.age.60.adj[7,] <- 100*(temp.13 - disc.age.60[7,])
disc.age.60.adj[8,] <- 100*(temp.14 - disc.age.60[8,])
disc.age.60.adj[9,] <- 100*(temp.15 - disc.age.60[9,])
disc.age.60.adj[10,] <- 100*(temp.16 - disc.age.60[10,])
disc.age.60.adj[11,] <- 100*(temp.17 - disc.age.60[11,])
disc.age.60.adj[12,] <- 100*(temp.18 - disc.age.60[12,])
disc.age.60.adj[13,] <- 100*(temp.19 - disc.age.60[13,])
disc.age.60.adj[14,] <- 100*(temp.20 - disc.age.60[14,])
...
## First I want to extract the information required for the illustrative example
## Age 50, 10 year risk 10%, events prevented if prescribing straight away vs waiting 10 years

## Risk straight away
disc.age.50.adj[8,1]

## Risk wait 10 years
disc.age.50.adj[8,11]

## Check age ranges again
min.max.prange.age.agetime

## For age 40, I decide to present 1%, 2%, 3%, 4% and 5%
...
plot.data.40 <- data.frame("age" = rep(40:89,5),
                           "ev.prevented" = c(disc.age.40.adj[1,],disc.age.40.adj[2,], 
                                              ...
                                              disc.age.40.adj[5,]),
                           "risk" = c(rep("1%",50),rep("2%",50),rep("3%",50),rep("4%",50),rep("5%",50)))
plot.data.40$risk <- factor(plot.data.40$risk, levels = c("1%","2%","3%","4%","5%"))
...
plot.data.50 <- data.frame("age" = rep(50:89,5),
                           "ev.prevented" = c(disc.age.50.adj[2,],disc.age.50.adj[4,], 
                                              disc.age.50.adj[6,],disc.age.50.adj[8,],
                                              disc.age.50.adj[10,]),
                           "risk" = c(rep("4%",40),rep("6%",40),rep("8%",40),rep("10%",40),rep("12%",40)))
plot.data.50$risk <- factor(plot.data.50$risk, levels = c("4%","6%","8%","10%","12%"))
...
plot.data.60 <- data.frame("age" = rep(60:89,6),
                           ...
                           "risk" = c(rep("8%",30),rep("10%",30),rep("12%",30),rep("14%",30),rep("16%",30),rep("18%",30)))
plot.data.60$risk <- factor(plot.data.60$risk, levels = c("8%","10%","12%","14%","16%","18%"))
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                                     common.legend = FALSE)
ggsave("figures/res_male_RR07.jpg",comb.plot, height = 9, width = 4.5)
ggsave("figures/Figure3.jpg",comb.plot, height = 9, width = 4.5, dpi=600)

save.image("R_out_C6/res_male_RR07.RData")
print("image saved")
