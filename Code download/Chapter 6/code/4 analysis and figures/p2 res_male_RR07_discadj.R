...
load("R_out_C6/runsim_male_RR07_discadj.RData")
...
## Get the risks if prescribing straight away for the 7% group, for each discontinuation rate
str(res.age.50.adj[[1]])

print("7%")
res.age.50.adj[[1]][5,1]
res.age.50.adj[[2]][5,1]
res.age.50.adj[[3]][5,1]
res.age.50.adj[[4]][5,1]
res.age.50.adj[[5]][5,1]

print("10%")
res.age.50.adj[[1]][8,1]
res.age.50.adj[[2]][8,1]
res.age.50.adj[[3]][8,1]
res.age.50.adj[[4]][8,1]
res.age.50.adj[[5]][8,1]
...
plot.40 <- ggplot(plot.data.40, aes(x = age, y = ev.prevented, col = risk)) + geom_point(size = 0.7) + xlab("Age at statin initiation") +
  ...
  labs(col = "Discont\ninuation\nrate") + scale_y_continuous(limits = c(0,12),breaks = seq(0,12,2)) 
...
comb.plot <- ggarrange(plot.40,plot.50,plot.60,nrow = 3, ncol = 1, 
                       common.legend = FALSE)
ggsave("figures/res_male_RR07_discadj.jpg",comb.plot, height = 9, width = 4.5)
ggsave("figures/Figure4.jpg",comb.plot, height = 9, width = 4.5, dpi = 600)

rm(anal.dat, comp.data)

save.image("R_out_C6/res_male_RR07_discadj.RData")
